...
if ( $(this).scrollTop() > 0 && $menu.hasClass("default") ){
	...
	rev.slick({
		...
		slidesToShow: 1,
		slidesToScroll: 1,
		asNavFor: '.slider-etaps-nav',
		appendArrows: rev.siblings('.controls-slider'),
		appendDots: rev.siblings('.controls-slider'),
		centerPadding: '0',
		swipe: true,
	...
	$('.link-tab').click(function(event) {
		event.preventDefault();
		$(this).parent().find(".link-tab").removeClass('active');
		$(this).addClass('active');
		$(".tab-pane-portfolio").fadeOut(0);
